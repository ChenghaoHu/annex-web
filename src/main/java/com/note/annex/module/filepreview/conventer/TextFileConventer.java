...
import com.note.annex.module.filepreview.utils.FileCharsetDetector;
    ...
    public void conventer(FileModel fileModel) {
        ...
        if (hashDir.exists() && hashDir.isDirectory()) {
            ...
            if (resourceDir.exists() && resourceDir.isDirectory()) {
                // 纯文本,涉及到文件编码问题
                try {
                    File original = new File(fileModel.getTempDir() + File.separator + fileModel.getOriginalFile());
                    ...
                    String outFile = resourceDirPath + File.separator
                            + FileUtil.getFileName(fileModel.getOriginalFile()) + "-utf8.txt";
